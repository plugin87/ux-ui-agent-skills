...
const checks = [
  ...
  ['Industry templates — checkout, CRM, patient chart, banking, freight (light + dark)',
   'node scripts/measure_render.mjs examples/templates/checkout.html && node scripts/measure_render.mjs --dark examples/templates/checkout.html && node scripts/verify_states.mjs examples/templates/checkout.html && node scripts/axe_audit.mjs --dark examples/templates/checkout.html && node scripts/verify_keyboard.mjs examples/templates/checkout.html && node scripts/verify_target_size.mjs examples/templates/checkout.html && node scripts/verify_interactive.mjs examples/templates/checkout.html && node scripts/verify_overflow.mjs examples/templates/checkout.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/checkout.html && node scripts/lint_intent.mjs examples/templates/checkout.html && node scripts/taste_audit.mjs --strict examples/templates/checkout.html && node scripts/measure_render.mjs examples/templates/crm.html && node scripts/measure_render.mjs --dark examples/templates/crm.html && node scripts/verify_states.mjs examples/templates/crm.html && node scripts/axe_audit.mjs --dark examples/templates/crm.html && node scripts/verify_keyboard.mjs examples/templates/crm.html && node scripts/verify_target_size.mjs examples/templates/crm.html && node scripts/verify_interactive.mjs examples/templates/crm.html && node scripts/verify_overflow.mjs examples/templates/crm.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/crm.html && node scripts/lint_intent.mjs examples/templates/crm.html && node scripts/taste_audit.mjs --strict examples/templates/crm.html && node scripts/measure_render.mjs examples/templates/emr.html && node scripts/measure_render.mjs --dark examples/templates/emr.html && node scripts/verify_states.mjs examples/templates/emr.html && node scripts/axe_audit.mjs --dark examples/templates/emr.html && node scripts/verify_keyboard.mjs examples/templates/emr.html && node scripts/verify_target_size.mjs examples/templates/emr.html && node scripts/verify_interactive.mjs examples/templates/emr.html && node scripts/verify_overflow.mjs examples/templates/emr.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/emr.html && node scripts/lint_intent.mjs examples/templates/emr.html && node scripts/taste_audit.mjs --strict examples/templates/emr.html && node scripts/measure_render.mjs examples/templates/banking.html && node scripts/measure_render.mjs --dark examples/templates/banking.html && node scripts/verify_states.mjs examples/templates/banking.html && node scripts/axe_audit.mjs --dark examples/templates/banking.html && node scripts/verify_keyboard.mjs examples/templates/banking.html && node scripts/verify_target_size.mjs examples/templates/banking.html && node scripts/verify_interactive.mjs examples/templates/banking.html && node scripts/verify_overflow.mjs examples/templates/banking.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/banking.html && node scripts/lint_intent.mjs examples/templates/banking.html && node scripts/taste_audit.mjs --strict examples/templates/banking.html && node scripts/measure_render.mjs examples/templates/logistics.html && node scripts/measure_render.mjs --dark examples/templates/logistics.html && node scripts/verify_states.mjs examples/templates/logistics.html && node scripts/axe_audit.mjs --dark examples/templates/logistics.html && node scripts/verify_keyboard.mjs examples/templates/logistics.html && node scripts/verify_target_size.mjs examples/templates/logistics.html && node scripts/verify_interactive.mjs examples/templates/logistics.html && node scripts/verify_overflow.mjs examples/templates/logistics.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/logistics.html && node scripts/lint_intent.mjs examples/templates/logistics.html && node scripts/taste_audit.mjs --strict examples/templates/logistics.html && node scripts/measure_render.mjs --dark examples/templates/orbital.html && node scripts/verify_states.mjs --dark examples/templates/orbital.html && node scripts/axe_audit.mjs --dark examples/templates/orbital.html && node scripts/verify_keyboard.mjs examples/templates/orbital.html && node scripts/verify_target_size.mjs examples/templates/orbital.html && node scripts/verify_overflow.mjs examples/templates/orbital.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/orbital.html && node scripts/taste_audit.mjs --strict examples/templates/orbital.html && node scripts/measure_render.mjs --dark examples/templates/tracing.html && node scripts/verify_states.mjs --dark examples/templates/tracing.html && node scripts/axe_audit.mjs --dark examples/templates/tracing.html && node scripts/verify_keyboard.mjs examples/templates/tracing.html && node scripts/verify_target_size.mjs examples/templates/tracing.html && node scripts/verify_overflow.mjs examples/templates/tracing.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/tracing.html && node scripts/taste_audit.mjs --strict examples/templates/tracing.html && node scripts/measure_render.mjs --dark examples/templates/daw.html && node scripts/verify_states.mjs --dark examples/templates/daw.html && node scripts/axe_audit.mjs --dark examples/templates/daw.html && node scripts/verify_keyboard.mjs examples/templates/daw.html && node scripts/verify_target_size.mjs examples/templates/daw.html && node scripts/verify_overflow.mjs examples/templates/daw.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/daw.html && node scripts/taste_audit.mjs --strict examples/templates/daw.html && node scripts/measure_render.mjs --dark examples/templates/atc.html && node scripts/verify_states.mjs --dark examples/templates/atc.html && node scripts/axe_audit.mjs --dark examples/templates/atc.html && node scripts/verify_keyboard.mjs examples/templates/atc.html && node scripts/verify_target_size.mjs examples/templates/atc.html && node scripts/verify_overflow.mjs examples/templates/atc.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/atc.html && node scripts/verify_reduced_motion.mjs examples/templates/atc.html && node scripts/taste_audit.mjs --strict examples/templates/atc.html && node scripts/measure_render.mjs --dark examples/templates/grid.html && node scripts/verify_states.mjs --dark examples/templates/grid.html && node scripts/axe_audit.mjs --dark examples/templates/grid.html && node scripts/verify_keyboard.mjs examples/templates/grid.html && node scripts/verify_target_size.mjs examples/templates/grid.html && node scripts/verify_overflow.mjs examples/templates/grid.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/grid.html && node scripts/verify_reduced_motion.mjs examples/templates/grid.html && node scripts/taste_audit.mjs --strict examples/templates/grid.html && node scripts/measure_render.mjs --dark examples/templates/genomics.html && node scripts/verify_states.mjs --dark examples/templates/genomics.html && node scripts/axe_audit.mjs --dark examples/templates/genomics.html && node scripts/verify_keyboard.mjs examples/templates/genomics.html && node scripts/verify_target_size.mjs examples/templates/genomics.html && node scripts/verify_overflow.mjs examples/templates/genomics.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/genomics.html && node scripts/verify_reduced_motion.mjs examples/templates/genomics.html && node scripts/taste_audit.mjs --strict examples/templates/genomics.html && node scripts/measure_render.mjs --dark examples/templates/editor.html && node scripts/verify_states.mjs --dark examples/templates/editor.html && node scripts/axe_audit.mjs --dark examples/templates/editor.html && node scripts/verify_keyboard.mjs examples/templates/editor.html && node scripts/verify_target_size.mjs examples/templates/editor.html && node scripts/verify_overflow.mjs examples/templates/editor.html && node scripts/verify_responsive.mjs --scale=1.25 examples/templates/editor.html && node scripts/verify_reduced_motion.mjs examples/templates/editor.html && node scripts/taste_audit.mjs --strict examples/templates/editor.html'],
  ['Trading terminal — ten chart types on one dense screen (light + dark)',
   'node scripts/measure_render.mjs examples/terminal/index.html && node scripts/measure_render.mjs --dark examples/terminal/index.html && node scripts/verify_states.mjs examples/terminal/index.html && node scripts/verify_states.mjs --dark examples/terminal/index.html && node scripts/axe_audit.mjs examples/terminal/index.html && node scripts/axe_audit.mjs --dark examples/terminal/index.html && node scripts/verify_keyboard.mjs examples/terminal/index.html && node scripts/verify_target_size.mjs examples/terminal/index.html && node scripts/verify_interactive.mjs examples/terminal/index.html && node scripts/verify_responsive.mjs examples/terminal/index.html --scale=1.25 && node scripts/verify_reduced_motion.mjs examples/terminal/index.html && node scripts/verify_overflow.mjs examples/terminal/index.html && node scripts/slop_tells.mjs --strict examples/terminal/index.html && node scripts/taste_audit.mjs --strict examples/terminal/index.html'],
  ['Showcase dashboard — a whole product screen, every gate that applies to it (light + dark)',
   'node scripts/measure_render.mjs examples/showcase/index.html && node scripts/measure_render.mjs --dark examples/showcase/index.html && node scripts/verify_states.mjs examples/showcase/index.html && node scripts/verify_states.mjs --dark examples/showcase/index.html && node scripts/axe_audit.mjs examples/showcase/index.html && node scripts/axe_audit.mjs --dark examples/showcase/index.html && node scripts/verify_keyboard.mjs examples/showcase/index.html && node scripts/verify_target_size.mjs examples/showcase/index.html && node scripts/verify_interactive.mjs examples/showcase/index.html && node scripts/verify_responsive.mjs examples/showcase/index.html --scale=1.25 && node scripts/verify_reduced_motion.mjs examples/showcase/index.html && node scripts/verify_overflow.mjs examples/showcase/index.html && node scripts/lint_intent.mjs examples/showcase/index.html && node scripts/slop_tells.mjs --strict examples/showcase/index.html && node scripts/taste_audit.mjs --strict examples/showcase/index.html'],
